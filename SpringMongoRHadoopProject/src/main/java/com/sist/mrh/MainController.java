...
public class MainController {
	...
	public void copyFromLocal(){
		try {
			...
			System.out.println("copyFromLocal : "+ex.getMessage());
		}
	}
	public void copyToLocal(){
		try {
			...
			System.out.println("copyToLocal : "+ex.getMessage());
		}
	...
	public void rGraph(){
		try {
			...
			rc.voidEval("png(\"/home/sist/bigdataDev/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/SpringMongoRHadoopProject/main/main.png\",width=800,height=700)");
			...
			System.out.println("rGraph : "+ex.getMessage());
		}
	}
}
